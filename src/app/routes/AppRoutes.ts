...
export const AppRoutes = {
    ...
    KNOWLEDGE_ARTICLE: env.ROUTE_KNOWLEDGE_ARTICLE,
    SEARCH: env.ROUTE_SEARCH,
    ANALYTICS: env.ROUTE_ANALYTICS,
    FORGOT_PASSWORD: env.ROUTE_FORGOT_PASSWORD,
    RESET_PASSWORD: env.ROUTE_RESET_PASSWORD,
